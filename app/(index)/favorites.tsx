...
const texts = [
  ...
  '배우자와 함께 주말에 드라마를 몰아서 보는 걸 좋아합니다. 스포일러를 피하고자 그때그때 남들이 재밌다는 제철 드라마를 보는 편인데, Apple TV 오리지널 시리즈를 대체로 선호합니다. 지금까지 본 드라마 중 가장 좋아하는 작품은 〈트윈픽스〉 시리즈이고, 〈뉴스룸〉 시리즈는 DVD까지 사서 여러 번 돌려봤으며, 〈이블〉은 수상할 정도로 제 취향을 너무 잘 버무려놓은 종합 선물 세트 같은 시리즈입니다. 그 외에도 〈테드 래소〉, 〈세브란스〉, 〈지하창고 사일로의 비밀〉 등을 좋아합니다.',
];
