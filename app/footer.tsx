...
export function Footer() {
  ...
  return (
    <footer className="mt-20 -z-10 bg-muted p-8">
      ...
      <ul className="mt-8 flex flex-row items-center gap-4">
        <li>
      ...
      <p className="text-sm opacity-50 mt-4">&copy; {new Date().getFullYear()}. <Link href='/' aria-label='홈으로 돌아가기'
                                                                                      className='no-underline hover:underline'>황성현</Link>.
